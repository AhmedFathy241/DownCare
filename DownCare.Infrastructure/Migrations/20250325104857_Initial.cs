    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActivitiyData", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalLinguisticsScore = table.Column<int>(type: "int", nullable: false),
                    TotalCommunicationScore = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OneWord = table.Column<int>(type: "int", nullable: false),
                    TwoWord = table.Column<int>(type: "int", nullable: false),
                    ThreeWord = table.Column<int>(type: "int", nullable: false),
                    FourWord = table.Column<int>(type: "int", nullable: false),
                    FiveWord = table.Column<int>(type: "int", nullable: false),
                    ChildId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommunicationScore", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommunicationScore_Children_ChildId",
                        column: x => x.ChildId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LinguisticsScore", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LinguisticsScore_Children_ChildId",
                        column: x => x.ChildId,
                        principalTable: "Children",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "/Images/منجا.png", "منجا", "/Sound/منجا.mp3", "OneWord" },
                    { 2, "/Images/موز.png", "موز", "/Sound/موز.mp3", "OneWord" },
                    { 101, "/Images/الولد يكتب.jpg", "الولد يكتب", "/Sound/الولد يكتب.mp3", "TwoWord" },
                    { 102, "/Images/الولد ينام.jpg", "الولد ينام", "/Sound/الولد ينام.mp3", "TwoWord" },
            ...
            migrationBuilder.InsertData(
                table: "ChatRooms",
                columns: new[] { "Id", "CreatedAt", "IsGroup", "Name" },
                values: new object[] { 1, new DateTime(2025, 3, 25, 12, 48, 56, 407, DateTimeKind.Local).AddTicks(3234), true, "MomsGroupChat" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommunicationScore_ChildId",
                table: "CommunicationScore",
                column: "ChildId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LinguisticsScore_ChildId",
                table: "LinguisticsScore",
                column: "ChildId",
                unique: true);
